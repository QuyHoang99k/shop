...
const heroSliderData = [
    ...
    },
    {
        ...
        description: "ベストは1日の中でも気温の変化が大きい秋口や春先にも長く使える便利なアイテム。軽くて柔らかい素材で、お子さまの元気な動きを妨げないのが魅力です。表はふわふわのフリース、裏は肌あたりのよい天竺のリバーシブルで、気分や寒さによって使い分けられます。ニットのレギンスは細リブ柄で女の子らしいデザイン。タイツのようにスカートに合わせてもかわいい。",
        img: img2,
        path: "/catalog/ao-thun-dinosaur-02",
        color: "pink"
    },
    {
        title: "フードの取り外しが可能！洗濯機で洗える中綿入り",
        description: "冬の防寒用に断然おすすめの1枚。中綿入りであたたかく、洗濯機で丸洗いできるのが大助かり。フードは取り外し可能なので、保育園のルールに合わせて使い分けて。襟やポケットの内側がフリースになっていて、やわらかく暖かいのもうれしい。トラッドなネイビーのアウターは、どんな服にもコーデしやすくて重宝します。",
        img: img3,
